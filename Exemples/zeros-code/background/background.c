...
int AgbMain() {
  ...
  BACKGROUND0_CONTROL=BACKGROUND_COLOR_256 | BACKGROUND_WHICH_CHARACTER(0) | BACKGROUND_WHICH_MAP(24) | TEXT_SIZE_256x256 | 0; // 3=priority
  ...
  backgroundPalette[1]=0x1F; //0x1F = 31 or red
